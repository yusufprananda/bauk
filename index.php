...
<head>
    ...
    <!-- Title -->
    <title>Badan Administrasi Umum</title>
...
<body>
    ...
    <!-- Widget Bottom -->
    <section class="cWidbot">
        <div class="container">
            <div class="row">
                <div class="col-md-3 text-center p-4">
                    <img class="imgLogo" src="img/logo.png" alt="Logo Universitas Ngudi Waluyo">
                    <p>Universitas Ngudi Waluyo<br>Kabupaten Semarang, Jawa Tengah, Indonesia.</p>
                </div>
    ...
    <footer class="cFooter">
        <div class="d-flex flex-row-reverse">
            <div class="p-3">
                <p class="m-0">Copyright © <?= date("Y") ?> | Biro Administrasi Umum | Universitas Ngudi Waluyo | All Rights Reserved</p>
            </div>
        </div>
    </footer>
